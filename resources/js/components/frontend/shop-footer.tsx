...
export default function ShopFooter() {
    return (
        <footer className="flex w-full flex-col items-center justify-center bg-[#6366F1] text-white">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <form className="space-y-2">
                            <Input className="border-white/20 bg-white/10 placeholder:text-white/50" placeholder="Enter email.." type="email" />
            ...
            <div className="border-t border-white/10">
                <div className="container flex flex-col items-center justify-center gap-4 py-6 text-center text-sm md:h-16 md:flex-row md:py-0">
                    <div className="text-white/60">Copyright@2023 All Right Reserved Pagedone.</div>
                </div>
            </div>
        </footer>
    );
